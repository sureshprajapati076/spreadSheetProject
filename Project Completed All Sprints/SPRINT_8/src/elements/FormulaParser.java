...
public abstract class FormulaParser {
	...
	private static String parseParenthesis(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			...
			if (str.charAt(i) == ')') {
				...
				System.out.println("\n\t\tCalculating inside parenthesis " + str.substring(pos, i + 1));
				str = str.replace(str.substring(pos, i + 1), String.valueOf(parseFormula(str.substring(pos + 1, i))));

				System.out.println("\nCurrent Expression:\t" + str);
